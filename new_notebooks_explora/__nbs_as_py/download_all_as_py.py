...
source_folder_path = '/content/drive/My Drive/Colab Notebooks/_shared oxford files/'

# Step 4: Define the target folder where you want to save the .py files
target_folder_path = '/content/drive/My Drive/Colab Notebooks/_shared oxford files/__nbs_as_py'

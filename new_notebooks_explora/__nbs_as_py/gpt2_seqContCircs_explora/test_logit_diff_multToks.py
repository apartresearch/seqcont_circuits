...
clean_text = "12 14 16"
corr_ans = ' 18'
corr_ans_tokLen, clean_score = clean_gen(model, clean_text, corr_ans)
...
clean_score - ablated_score  # the higher the score, the more was ablated


# In[41]:


(ablated_score / clean_score) * 100

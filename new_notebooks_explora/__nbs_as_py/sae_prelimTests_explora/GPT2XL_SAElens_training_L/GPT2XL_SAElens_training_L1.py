...
cfg = LanguageModelSAERunnerConfig(
    ...
    hook_point="blocks.1.hook_mlp_out",  # A valid hook point (see more details here: https://neelnanda-io.github.io/TransformerLens/generated/demos/Main_Demo.html#Hook-Points)
    hook_point_layer=1,  # Only one layer in the model.
    ...
    # log_to_wandb=False,
    wandb_project="sae_lens_exploraTest_L1",

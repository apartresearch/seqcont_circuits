...
data_dict = {
    (0, 0): 0.1, (1, 2): 0.2, (2, 4): -0.1, (3, 6): 0.15, (4, 8): -0.05,
    (22, 10): 0.25, (20, 12): -0.2, (18, 14): 0.05, (16, 16): 0.1, (14, 18): -0.1
...
pivot_table = df.pivot('Layer', 'Head', 'Value').fillna(0)

# Plot the heatmap
plt.figure(figsize=(10, 8))
sns.heatmap(pivot_table, cmap='coolwarm', center=0, annot=False, cbar=True)
plt.xlabel('Head')
plt.ylabel('Layer')

...
intersect_all = list(set(spanish_nw) & set(nw_circ) & set(months_circ) & set(spanish_months))


# In[34]:


intersect_en_nw_months = list(set(nw_circ) & set(months_circ))


# In[35]:


circ_multp_124 = [(4, 3), (6, 11), (16, 0), (5, 15), (12, 2), (17, 31), (18, 14), (3, 6), (12, 15), (3, 24), (15, 15), (15, 25), (7, 27), (22, 9), (3, 19), (5, 25), (4, 4), (6, 31), (5, 29), (4, 16), (11, 28), (16, 27), (21, 17), (12, 22), (8, 0), (5, 16), (6, 14), (2, 30), (7, 21), (1, 15), (14, 7), (0, 15), (12, 18), (9, 5), (2, 2), (6, 24), (22, 25), (6, 5), (10, 9), (0, 1), (6, 12), (15, 24), (16, 19), (16, 29), (16, 4), (10, 25), (3, 7), (12, 23), (0, 2), (14, 4), (7, 30), (3, 26), (6, 27), (3, 15), (10, 10), (9, 27), (4, 26), (6, 1), (6, 20), (22, 14), (7, 29), (11, 16), (14, 3), (3, 2), (6, 28), (10, 30), (4, 12), (3, 23), (0, 5), (4, 18), (15, 21), (16, 13), (3, 10), (4, 28), (4, 22), (11, 13), (9, 1), (9, 3), (9, 2), (3, 9), (6, 30), (4, 27), (3, 13), (10, 11), (11, 12), (16, 8), (3, 22), (4, 19), (2, 0), (3, 28), (3, 3), (4, 23), (1, 29), (12, 24), (11, 18), (1, 22), (7, 25), (0, 24)]
...
singleTok_multp = [(12, 22), (16, 0), (17, 31), (14, 19), (22, 25), (29, 5), (6, 24), (5, 26), (21, 17), (0, 15), (2, 5), (16, 27), (19, 22), (0, 13), (0, 14), (3, 13), (13, 11), (15, 15), (18, 26), (19, 6), (0, 21), (13, 14), (5, 15), (19, 10), (3, 2), (4, 0), (9, 5), (5, 2), (10, 5), (19, 11), (10, 6), (0, 25), (18, 31), (14, 2), (16, 24), (3, 16), (20, 17), (8, 0), (14, 27), (15, 5), (5, 16), (9, 2), (7, 24), (5, 24), (6, 5), (6, 14), (7, 30), (20, 16), (4, 3), (5, 9), (0, 2), (6, 11), (2, 28), (9, 31), (1, 19), (7, 18), (3, 24), (0, 29), (6, 22), (13, 6), (6, 31), (2, 2), (2, 12), (2, 18), (6, 19), (8, 1), (2, 20), (16, 5), (7, 13), (8, 16), (15, 9), (9, 7), (5, 0), (6, 4), (3, 15), (13, 2), (7, 19), (14, 24), (6, 3), (16, 2), (16, 13), (16, 31), (2, 7), (2, 0), (2, 24), (16, 10), (6, 23), (1, 20), (13, 1), (1, 18), (8, 30), (9, 9), (7, 8), (1, 30), (6, 15), (16, 26), (0, 30), (0, 12), (8, 29), (2, 23), (9, 6), (20, 20), (3, 27), (8, 2), (16, 7), (2, 1), (6, 7), (6, 18), (16, 4), (9, 10), (3, 29), (16, 9), (2, 13), (6, 25), (2, 22), (0, 7), (2, 19), (16, 8), (19, 30), (5, 28), (1, 1), (1, 22)]
...
len(list(set(circ_multp_124) & set(singleTok_multp)))


# In[61]:


len(list(set(circ_multp_124) & set(nw_circ)))
...
instruction = "Be concise. "
clean_text =  "In a cyclic pattern of colors: Red, Blue, Green, Yellow, what color comes after Green in the 3rd cycle?"
clean_text = instruction + clean_text
corr_text = "uno uno uno" # dos tres cinco seis
heads_not_ablate = [(layer, head) for layer in range(32) for head in range(32)]  # unablated
mlps_not_ablate = [layer for layer in range(32)]
...
heads_not_ablate = [(layer, head) for layer in range(32) for head in range(32)]  # unablated
head_to_remove = intersect_en_nw_months
heads_not_ablate = [x for x in heads_not_ablate if (x not in head_to_remove)]
...
head_to_remove = choose_heads_to_remove(filtered_pairs, heads_of_circ, 100, 10)
...
clean_text = "Be concise. If today is the 11th of a month, what date will it be in 6 days?"
# corr_text = "uno uno uno" # dos tres cinco seis
num_toks_gen = 10
...
clean_text = "Be concise. In a cyclic pattern of colors: Red, Blue, Green, Yellow, what color comes after Green in the 3rd cycle?"
# corr_text = "uno uno uno" # dos tres cinco seis
num_toks_gen = 6

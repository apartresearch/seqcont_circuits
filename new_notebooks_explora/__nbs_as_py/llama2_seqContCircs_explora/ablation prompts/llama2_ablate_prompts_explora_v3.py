...
heads_not_ablate = [(layer, head) for layer in range(32) for head in range(32)]  # unablated
head_to_remove_num = ([(5, 25), (20, 17), (3, 24), (16, 0), (4, 3), (8, 0), (22, 25), (6, 11), (28, 5), (8, 4), (31, 4), (30, 13), (5, 15), (30, 31), (12, 2), (12, 15), (12, 22), (10, 13), (11, 28), (14, 7), (4, 16), (29, 5), (27, 31), (16, 24), (29, 30), (28, 16), (7, 30), (5, 11), (18, 26), (9, 31), (12, 23), (18, 17), (7, 0), (8, 15), (31, 11), (29, 1), (2, 4), (5, 16), (26, 30), (22, 10), (30, 24), (31, 12), (7, 21), (25, 3), (2, 24), (14, 1), (10, 6), (31, 30), (0, 25), (18, 31)])
...
heads_not_ablate = [(layer, head) for layer in range(32) for head in range(32)]  # unablated
head_to_remove = ([(5, 25), (20, 17), (3, 24), (16, 0), (4, 3), (8, 0), (22, 25), (6, 11), (28, 5), (8, 4), (31, 4), (30, 13), (5, 15), (30, 31), (12, 2), (12, 15), (12, 22), (10, 13), (11, 28), (14, 7), (4, 16), (29, 5), (27, 31), (16, 24), (29, 30), (28, 16), (7, 30), (5, 11), (18, 26), (9, 31), (12, 23), (18, 17), (7, 0), (8, 15), (31, 11), (29, 1), (2, 4), (5, 16), (26, 30), (22, 10), (30, 24), (31, 12), (7, 21), (25, 3), (2, 24), (14, 1), (10, 6), (31, 30), (0, 25), (18, 31)])
heads_not_ablate = [x for x in heads_not_ablate if (x not in head_to_remove)]
...
# # Define heads_of_circ somewhere in the code
# heads_of_circ = [...]  # Define this list with appropriate values
...
# # Randomly choose 50 pairs from the filtered list
# head_to_remove = random.sample(filtered_pairs, 50)

# # Generate the list of heads that are not ablated
# heads_not_ablate = [(layer, head) for layer in range(32) for head in range(32)]
# heads_not_ablate = [x for x in heads_not_ablate if x not in head_to_remove]

# # Generate the list of mlps that are not ablated
# mlps_not_ablate = [layer for layer in range(32)]

# # Call the ablate_then_gen function with the necessary parameters
# ablate_then_gen(model, clean_text, corr_text, heads_not_ablate, mlps_not_ablate, 6)
...
heads_of_circ = ([(5, 25), (20, 17), (3, 24), (16, 0), (4, 3), (8, 0), (22, 25), (6, 11), (28, 5), (8, 4), (31, 4), (30, 13), (5, 15), (30, 31), (12, 2), (12, 15), (12, 22), (10, 13), (11, 28), (14, 7), (4, 16), (29, 5), (27, 31), (16, 24), (29, 30), (28, 16), (7, 30), (5, 11), (18, 26), (9, 31), (12, 23), (18, 17), (7, 0), (8, 15), (31, 11), (29, 1), (2, 4), (5, 16), (26, 30), (22, 10), (30, 24), (31, 12), (7, 21), (25, 3), (2, 24), (14, 1), (10, 6), (31, 30), (0, 25), (18, 31)])
...
# Randomly choose 50 pairs ensuring less than 10 overlaps with heads_of_circ
head_to_remove = choose_heads_to_remove(filtered_pairs, heads_of_circ, 50, 10)
...
# top 50 heads from seqcont multi prompt 1234
...
ablate_then_gen(model, clean_text, corr_text, heads_not_ablate, mlps_not_ablate, 70)
